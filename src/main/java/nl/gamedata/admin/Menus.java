...
public class Menus
{
    ...
    static
    {
        ...
        userTabs.add(new Tab("user", "User", true, Set.of(0, 1, 2)));
        userTabs.add(new Tab("game", "Game", true, Set.of(0, 1)));
        userTabs.add(new Tab("organization-role", "Organization Role", false, Set.of(0, 2)));
        ...
        gameTabs.add(new Tab("game", "Game", true, Set.of(0, 1)));
        ...
        gameControlTabs.add(new Tab("game", "Game", true, Set.of(0, 3)));
        gameControlTabs.add(new Tab("organization", "Organization", true, Set.of(0, 3)));
        ...
        gameSessionTabs.add(new Tab("game", "Game", true, Set.of(0, 4)));
        ...
        dashboardTabs.add(new Tab("game", "Game", true, Set.of(0, 5)));
        ...
        dataSessionTabs.add(new Tab("game", "Game", true, Set.of(0, 4)));
        ...
        dataPlayerTabs.add(new Tab("game", "Game", true, Set.of(0, 4)));
        ...
        dataGroupTabs.add(new Tab("game", "Game", true, Set.of(0, 4)));
